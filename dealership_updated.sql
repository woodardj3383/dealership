...
DROP TABLE IF EXISTS payment_attributes
...
UPDATE payment_attributes
SET financing_number = 687645
WHERE account_number = 56438467
...
DELETE FROM payment_attributes USING payment_attributes
WHERE payment_attributes.invoice_number > 
	
SELECT * FROM payment_attributes
WHERE payment_attributes.ctid = 1
	
SELECT ROW_NUMBER() OVER() FROM payment_attributes

DELETE ROW_NUMBER() OVER() FROM payment_attributes
